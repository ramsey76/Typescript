import {Person} from "./interface-functions"
import tom from "./interface-functions";
...
function filterByTerm(input: Link[], searchTerm: string): Link[] {
  ...
  let arno: Person = {age: 23, city: "Maastricht", name: "Arno", 
                    printDetails: function() {
                      console.log(`I Live in the city of ${this.city}.`)
                    },
                    printWelcome: function(welcome: string): string{
                        return "hello world";
                    },
                  };

  //console.log(arno.printWelcome("test"));
console.log(tom.printWelcome("Goededag"));
